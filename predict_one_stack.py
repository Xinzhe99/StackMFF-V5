...
import os
import argparse
from model.network import StackMFF_V5
...
def main():
    ...
    parser.add_argument("--model_path", type=str, default='/home/ot/Students/xxz/projects_mff/StackMFFV5/train_runs/train_runs9/model_save/epoch_5.pth',
                        help="训练好的模型权重路径")
    parser.add_argument("--input_dir", type=str, default='/home/ot/Students/xxz/datasets/test_datasets/Road-MF/image stack/17',
                        help="包含图像栈的目录路径")
    parser.add_argument("--output_dir", type=str, default='/home/ot/Students/xxz/projects_mff/StackMFFV5/stackmffv5_outputs/batch_results_20260107_162203/Road-MF',
                        help="融合结果保存路径")
